    ...
    <body>
        <%-- <table>
            <tr>
                ...
                <th>Design</th>
                <th> <button><a href="/demo/ajouter/avion">Ajouter</a></button> </th>
            </tr>
            <%
                ...
                out.println("<td> <a href='/demo/modifier/avion?id_modifier="+data[i][0]+"'>Modifier</a> <a href='/demo/supprimer/avion?id_supprimer="+data[i][0]+"&id_vol="+data[i][1]+"'>Supprimer</a> </td>");
                out.println("</tr>");
            } %>
        </table>
        ...
        <div class="content">
            ...
            <section>
                ...
                <div class="card avion shadow-sm p-3 mb-5 rounded">
                    <img src="<%=request.getContextPath()%>/Image/bgAvion.png" class="card-img-top bg-info" alt="..." style="height: 300px;">
                    <div class="card-header">
                        <h3 class="text-center text-warning">Liste des avions disponible</h3>
                    </div>
                    <div class="card-body table-responsive">
                        <table class="table table-bordered text-center">
                            <thead>
                                <tr>
                                    <th scope="col">Numéro avion</th>
                            ...
                            <tbody>
                                <%
                                    ...
                                    for(int i= 0; i < data.length;i++){
                                        ...
                                        out.println("<a href='/demo/voyageurs?nAvion="+data[i][0]+"' class='dropdown-item' type='button'>Visualiser</a>");
                                        out.println("<a href='/demo/modifier/avion?id_modifier="+data[i][0]+"' class='dropdown-item' type='button'>Edit</a>");
                                        out.println("<a href='/demo/supprimer/avion?id_supprimer="+data[i][0]+"&id_vol="+data[i][1]+"' class='dropdown-item' type='button'>Delete</a>");
                                        out.println("</div>");
                                        out.println("</div>");
                                        out.println("</td>");
                                        out.println("</tr>");
                    ...
                    <div class="card-footer row">
                        <ul class="list-group list-group-horizontal col">
                            <%
                                String[] annee = (String[]) request.getAttribute("allAnnee");
                                for(int i= 0; i < annee.length; i++){
                                    out.println("<a class='list-group-item border-0' href='/demo/chart/recette?annee="+annee[i]+"'>Recette "+annee[i]+"</a>");
                                }
                            %>
                        </ul>
                        <ul class="pagination justify-content-end mt-3 col">
                            <li class="page-item mr-2">
                                <a class="page-link text-white bg-primary" href="/demo/ajouter/avion">
