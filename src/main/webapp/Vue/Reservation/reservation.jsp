    ...
    <div class="sidebar">
        ...
        <div class="content">
            ...
            <section>
                ...
                <div class="card avion shadow-sm p-3 mb-5 rounded">
                    <img src="<%=request.getContextPath()%>/Image/bgReservation.jpg" class="card-img-top bg-info" alt="..." style="height: 300px;">
                    <div class="card-header">
                        <h3 class="text-center text-warning">Liste des réservations disponible</h3>
                    </div>
                            ...
                            <tbody>
                                <%
                                    ...
                                    for(int i= 0; i < data.length;i++){
                                        ...
                                        out.println("<a href='/demo/modifier/reservation?id_modifier="+data[i][0]+"' class='dropdown-item' type='button'>Edit</a>");
                                        out.println("<a href='/demo/supprimer/reservation?id_supprimer="+data[i][0]+"&id_place="+data[i][2]+"' class='dropdown-item' type='button'>Delete</a>");
                                        out.println("</div>");
                                        out.println("</div>");
                                        out.println("</td>");
                                        out.println("</tr>");
                    ...
                    <div class="card-footer">
                        <ul class="pagination justify-content-end mt-3">
                            <li class="page-item mr-2">
                                <a class="page-link text-white bg-primary" href="/demo/ajouter/reservation">
        ...
        <%-- <table>
            <tr>
                ...
                <th> <button><a href="/demo/ajouter/reservation">Ajouter</a></button> </th>
            </tr>
            <%
                String[][] data = (String[][]) request.getAttribute("data");
                for(int i= 0; i < data.length;i++){
                ...
                out.println("<td>"+data[i][3]+"</td>");
                out.println("<td>"+data[i][4]+"</td>");
                out.println("<td> <a href='/demo/modifier/reservation?id_modifier="+data[i][0]+"'>Modifier</a> <a href='/demo/supprimer/reservation?id_supprimer="+data[i][0]+"&id_place="+data[i][2]+"'>Supprimer</a> </td>");
                out.println("</tr>");
            } %>
        </table>
